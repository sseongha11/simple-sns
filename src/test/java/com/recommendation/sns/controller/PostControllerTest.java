...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser
    void GivenValidInformationWhenPostThenReturnJson() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void GivenAnonymousUserNotFoundWhenPostThenReturnErrors() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void GivenWhenPostModificationReturn() throws Exception {
